...
const menuItemDefs = [
  { id: 'dashboard', labelKey: 'nav.dashboard', path: '/agent', icon: '/svg/dashboard.svg' },
  { id: 'settings', labelKey: 'nav.settings', path: '/agent/settings', icon: '/svg/setting.svg' },
  { id: 'inventory', labelKey: 'nav.inventory', path: '/agent/inventory', icon: '/svg/inventory.svg' },
  { id: 'history', labelKey: 'nav.history', path: '/agent/history', icon: '/svg/history.svg' },
  { id: 'app-users', labelKey: 'nav.appUsers', path: '/agent/app-users', icon: '/svg/user_check.svg' },
];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800">{t('common.agent')}</span>
                  <svg
